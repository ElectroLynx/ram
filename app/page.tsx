  ...
  return (
    <div>
      <main className="flex flex-col items-center justify-center min-h-screen gap-6">
        ...
        <p> Vous pouvez avoir { (parseFloat(montant) / parseFloat(prixRAM)).toFixed(2) } GB de RAM</p>
      </main>
      <footer className="flex flex-col justify-between items-center border-t border-slate-800 p-4">
        <p>Calculateur de RAM. Créé par ElectroLynx.</p>
        <a href="https://github.com/ElectroLynx/ram" target="_blank" rel="noopener noreferrer">
          <p className="hover:underline hover:text-blue-400">Repo sur GitHub</p>
        </a>
      </footer>
    </div>
  );
